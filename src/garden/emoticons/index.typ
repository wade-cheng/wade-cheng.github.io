...
#quote(block: true, attribution: link("https://www.britannica.com/story/whats-the-difference-between-emoji-and-emoticons")[The Encyclopædia Britannica])[
...
/ #"<|:) and <]:) and {||]:0 and @¦¬ :o": Continuing on the theme of novelty emoticons, here's some from #link("https://www.tumblr.com/thatsridicarus/184818824517").#footnote[
    Here's a backup in case the link dies:
    #html.img(
      src: "./hats.jpg",
      alt: ```
        castlevania:
        ...
        *puts on a cowboy hat*
        ...
        kevbrinx:
        @¦¬ :o
        and a drawing of them four together as cutsie stick figures
        ```.text
    )
    ] A wizard, a cowboy, a burger, and a flower hat. 
